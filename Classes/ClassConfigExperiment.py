class Config : 
 ...
 #the format of the config file must be that of "/grid_mnt/data__DATA/data.lhcb/PRL/Configs/config_experiment.txt")
  ...
  def __init__(self, cfgfile = ""):
    ...
    self._fichier = None
    self._keys = ["min_z","max_z","min_FTHit","max_FTHit","mu_factor","bx_rate","nb_of_bit_BX_id"]
  ...
  def verif_format(self):
    ...
    keys = ["min_z","max_z","min_FTHit","max_FTHit","mu_factor","bx_rate","nb_of_bit_BX_id"]
    lines = self._lines
