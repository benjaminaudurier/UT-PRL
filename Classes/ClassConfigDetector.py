class Config : 
 #creates the config objects, whose attributes caracterize the detector and the simulated experiment (study zone, pixel size, amount of pixels per chip...)
 #the format of the config file has to be the same as that of "/grid_mnt/data__DATA/data.lhcb/PRL/Configs/config_detector.txt"
  def __init__(self, cfgfile = ""):
    ...
    self._fichier = None
    self._lines = [[]]
    self._keys = ["frmt_pxl",'spcng_pxl_x','spcng_pxl_y','nb_lign_pxl_chp','nb_coln_pxl_chp','zn_mrt_chp_gau','zn_mrt_chp_dro','zn_mrt_chp_bas','zn_mrt_chp_hau','spcng_chp_x','spcng_chp_y','nb_lign_chp_mdl','nb_coln_chp_mdl','spcng_mdl_x','spcng_mdl_y','nb_lign_mdl_stv','nb_coln_mdl_stv','spcng_stv_x','spcng_stv_y', 'nb_lign_stv','nb_coln_stv','zn_mrt_center_x','zn_mrt_center_y']
  ...
  def verif_format(self):
    ...
    keys = ["frmt_pxl",'spcng_pxl_x','spcng_pxl_y','nb_lign_pxl_chp','nb_coln_pxl_chp','zn_mrt_chp_gau','zn_mrt_chp_dro','zn_mrt_chp_bas','zn_mrt_chp_hau','spcng_chp_x','spcng_chp_y','nb_lign_chp_mdl','nb_coln_chp_mdl','spcng_mdl_x','spcng_mdl_y','nb_lign_mdl_stv','nb_coln_mdl_stv','spcng_stv_x','spcng_stv_y', 'nb_lign_stv','nb_coln_stv','zn_mrt_center_x','zn_mrt_center_y']
    lines = self._lines
    errorMessage = "The file does not correspond to a config file of the detector"
    bool = True
    try :
      assert lines[0][0] == "Configuration of the detector "
      print("Chceking 1st line")
    except : 
      print(errorMessage)
  ...
  def remplissage_dict_config_detector(self):
    ...
    self._dict["wth_chp"] = (w+self._dict["spcng_pxl_x"])*self._dict['nb_coln_pxl_chp']
    self._dict["hgt_chp"] = (h+self._dict["spcng_pxl_y"])*self._dict['nb_lign_pxl_chp']
    #width and height for module
    self._dict["wth_mdl"] = (self._dict["wth_chp"]+self._dict["spcng_chp_x"]+self._dict['zn_mrt_chp_dro']+self._dict['zn_mrt_chp_gau'])*self._dict['nb_coln_chp_mdl']
    self._dict["hgt_mdl"] = (self._dict["hgt_chp"]+self._dict["spcng_chp_y"]+self._dict['zn_mrt_chp_hau']+self._dict['zn_mrt_chp_bas'])*self._dict['nb_lign_chp_mdl']
    #width and height for stave
    self._dict["wth_stv"] = (self._dict["wth_mdl"]+self._dict["spcng_mdl_x"])*self._dict['nb_coln_mdl_stv']
    self._dict["hgt_stv"] = (self._dict["hgt_mdl"]+self._dict["spcng_mdl_y"])*self._dict['nb_lign_mdl_stv']
    #width and height for detector
    self._dict["wth_det"] = (self._dict["wth_stv"]+self._dict["spcng_stv_x"])*self._dict['nb_coln_stv']
    self._dict["hgt_det"] = (self._dict["hgt_stv"]+self._dict["spcng_stv_y"])*self._dict['nb_lign_stv']
